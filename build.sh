...
export PATH="$OPPO_K10X_RootPath/compiler/clang-11.0.2/bin:$OPPO_K10X_RootPath/compiler/aarch64-linux-android-4.9/bin:$OPPO_K10X_RootPath/compiler/arm-linux-androideabi-4.9/bin:$PATH"
